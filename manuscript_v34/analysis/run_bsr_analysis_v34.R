# Phase 1-2 (v34): BF Case Study Analysis
...
cat("============================================\n")
cat("PHASE 1-2 (v34): BF Case Study Analysis\n")
cat("============================================\n\n")

# ---- Load Data (v33-derived RDS files, copied into v34/output) ----
...
saveRDS(results, file.path(OUT_DIR, "data", "bsr_results_v34.rds"))
cat(sprintf("\nSaved: %s\n", file.path(OUT_DIR, "data", "bsr_results_v34.rds")))
cat("===== PHASE 1-2 (v34) COMPLETE =====\n")
