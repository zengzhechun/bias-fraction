#!/bin/bash
# ============================================================================
# v39b downstream rebuild after adding the K = 50 negative-control tier.
#
...
#
# Order matters: 18 writes v39_all_numbers.json, and 20 reads it back, so 18
...
echo "============================================================"
echo " v39b downstream rebuild  (K = 50 tier)"
...
# 1) master numbers + CSVs + Part II figures (writes v39_all_numbers.json)
run "18_three_part" Rscript R/18_v39_three_part_analysis.R

# 2) Bland-Altman tri-panel, true-BF view (Figure 1)
run "ba_mcmc_2d"    Rscript analysis/v39_step1_ba_mcmc_2d_density.R
...
echo "   manuscript/manuscript_jama_v39.qmd  (Fig 1, Fig 2, Table 2 captions)"
echo " then render with:  quarto render manuscript_jama_v39.qmd --to docx"
